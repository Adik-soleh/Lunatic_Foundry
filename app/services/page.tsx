...
const cardStyles = [
  {
    ...
    glow: 'hover:shadow-[0_0_40px_rgba(233,195,230,0.6)]'
  },
  {
    bg: 'bg-[#C6E23B]',
    textColor: 'text-[#2D2D2D]',
    glow: 'hover:shadow-[0_0_40px_rgba(198,226,59,0.6)]'
  },
  {
    bg: 'bg-[#001489]',
    textColor: 'text-white',
    glow: 'hover:shadow-[0_0_50px_rgba(0,20,137,0.5)]'
  },
];
                  ...
                  <Link href={`/services/${service.slug}`} className="block h-full">
                    <div className={`${style.bg} ${style.glow} rounded-[40px] p-10 h-full flex flex-col justify-end min-h-[500px] transition-all duration-500 relative overflow-hidden group`}>
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-white/70 text-base mb-8 max-w-xs">{service.description}</p>
